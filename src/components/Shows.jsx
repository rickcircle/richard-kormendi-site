            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.05 }}
              ...
              <div style={{ display: "flex", gap: "0.75rem", justifyContent: "center", flexWrap: "wrap" }}>
                ...
                <a href="#newsletter"
                  ...
                  style={{ fontSize: "0.8rem", letterSpacing: "0.06em", color: "#fff", textDecoration: "none", background: ACCENT, borderRadius: "2px", padding: "0.6rem 1.25rem", boxShadow: "0 0 16px rgba(209, 107, 99,0.3)" }}>
                  {tx.noShowsNotify}
                </a>
              </div>
            </motion.div>
