...
const TX = {
  en: {
    ...
    packages: {
      ...
      items: [
        {
          name: "Starter", price: "220 000 Ft", period: "", highlight: false,
        ...
        {
          name: "Business", price: "380 000 Ft", period: "", highlight: true,
  ...
  hu: {
    ...
    packages: {
      ...
      items: [
        {
          name: "Alap", price: "220 000 Ft", period: "", highlight: false,
        ...
        {
          name: "Üzleti", price: "380 000 Ft", period: "", highlight: true,
